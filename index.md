...
* *Zagier-Hoffman's conjectures in positive characteristic* (with [Bo-Hae Im], Khac Nhuan Le, [Tuan Ngo Dac], Lan Huong Pham), **Forum Math. Pi**, 12 (2024), Paper No. e18. [[journal link](https://doi.org/10.1017/fmp.2024.18)]
* *On the common zeros of quasi-modular forms for $\Gamma_0^+(N)$ of level $N=1,2,3$* (with [Bo-Hae Im], [Wonwoong Lee]), **Open Math.** 22 (2024), no. 1, Paper No. 20240065. [[journal link](https://www.degruyter.com/document/doi/10.1515/math-2024-0065)]
* *Note on the linear independence of alternating multiple zeta values in positive characteristic* (with [Bo-Hae Im], Khac Nhuan Le, [Tuan Ngo Dac], Lan Huong Pham), **Acta Math Vietnam** 49, 485–521 (2024). [[journal link](https://doi.org/10.1007/s40306-024-00554-4)]
...
### Preprints
* *The threshold for linear independence of multiple zeta values in positive characteristic* (with [Bo-Hae Im], [Tuan Ngo Dac]), submitted, 2026. [[preprint](https://arxiv.org/abs/2604.25451)]
...
<!-- * 2025 
  * A Linear Independence of the Multiple Zeta Values in Positive Characteristics
    * [33èmes Journées Arithmétiques](https://www.uni.lu/fstm-en/conferences/ja25/) (30 June - 4 July, 2025. Esch-sur-Alzette, Luxembourg)
  * A Linear Independence of the Multiple Zeta Values in Positive Characteristic
    * [XXXIII<sup>e</sup> Rencontres Arithmétiques de Caen: Aspects $p$-adiques et modulo $p$](https://renc-arith-2024.sciencesconf.org) (18-20 June, 2025. Caen, France)
  * Algebraic Structures of Multiple Zeta Values in Positive Characteristic
    * KIAS Number Theory Seminar (May 22, 2025. Online)
* 2024
  * Hopf algebra structures of Multiple Zeta Values in positive characteristics
    * Workshop, [School and Workshop "Selected topics in Arithmetic Algebraic Geometry"](http://math.ac.vn/conference/SWSAAG2024/index.php?lang=en) (Oct. 28 - Nov. 8, 2024. Hanoi, Vietnam)
* 2022
  * Riemann hypothesis for period polynomials attached to the derivatives of $L$-functions of cusp forms for $\Gamma_0(N)$
    * Special session on Automorphic Forms and $q$-Series, [2022 Global KMS International Conference](http://math.ac.vn/conference/SWSAAG2024/index.php?lang=en) (Oct. 18 - 21, 2022. Seoul, Korea) -->
{% endcomment %}
...
I received the Teaching Assistant Excellence Awards in [2021 Spring](https://mathsci.kaist.ac.kr/home/2021/09/2021년-봄학기-우수조교상), [2022 Spring](https://mathsci.kaist.ac.kr/home/2022/09/2022년-봄학기-우수조교상-시상식/), and [2023 Spring](https://mathsci.kaist.ac.kr/home/2023/09/2023년-bk21-plus-대학원-워크샵-개최/).
...
* [MathSciNet](https://mathscinet.ams.org/)
  * My MR Number is [1481947](https://mathscinet.ams.org/mathscinet/search/author.html?mrauthid=1481947).
* [Recent NT preprints on arXiv](https://arxiv.org/list/math.NT/recent)
* [deTEXify](https://detexify.kirelabs.org/classify.html)
* [French-Korean Number Theory Seminar](https://www.math.u-bordeaux.fr/~pthieull/LIA/webinars_NT.html)

<!-- ### LMNO, UniCAEN
* [Digital account](https://moncomptenumerique.unicaen.fr/)
* [Email](https://webmail.unicaen.fr/#1)
* [LMNO](https://lmno.unicaen.fr)
  * [LMNO seminars](https://lmno.unicaen.fr/seminaires/) -->

### Other links 

* My [GitHub repository](https://github.com/hojin-kim)
<!-- * I have a [YouTube channel](https://www.youtube.com/@see_some_music) (not many videos there). -->
* You can access this page via URL [https://hojin.kim](https://hojin.kim).


[Bo-Hae Im]: https://sites.google.com/view/imbh/home
[Tuan Ngo Dac]: http://tuan.ngodac.perso.math.cnrs.fr
[Wonwoong Lee]: https://sites.google.com/site/leewwmath/wonwoong-lee이원웅
[Seokhyun Choi]: https://sites.google.com/view/seokhyun-choi
[Beomho Kim]: https://mathsci.kaist.ac.kr/~bhkim/
[Hansol Kim]: https://sites.google.com/view/hansol-kim
[cvlink]: /assets/cv-public.pdf
